...
const NewsSection = ({ news, viewType }) => {
    ...
    return (_jsxs("div", { className: "news-container", children: [_jsx("div", { className: viewType === "grid" ? "news-grid" : "news-list", children: paginatedNews.map((article, index) => (_jsxs("div", { className: "news-item", children: [_jsx(NewsCard, { article: article, onClick: () => console.log("News clicked") }), _jsx("button", { className: "delete-btn", onClick: () => console.log("Delete"), children: "\u2716" })] }, index))) }), _jsx("div", { className: "pagination", children: Array.from({ length: totalPages }, (_, index) => (_jsx("button", { className: `page-btn ${currentPage === index + 1 ? "active" : ""}`, onClick: () => setCurrentPage(index + 1), children: index + 1 }, index + 1))) })] }));
};
